...
<html lang="id">
    <head>
        ...
        <meta name="keywords" content="dinas,dikpora, disdikpora,wonosobo,jawa-tengah,dinas-pekerjaan-umum,penataan-ruang">
    ...
    <body id="_top">
        ...
        <header id="header1" class="pb-5 bg-light border-bottom mb-0" style="background-image: url('<?php echo base_url(); ?>/assets/bg-baru.png');">
            ...
            <nav id="navku" class="navbar fixed-top d-none">
                <div class="container">
                    ...
                    <div class="d-flex justify-content-end align-items-center">
                        <ul class="navbarku">
                            <li><a href="<?php echo base_url(); ?>" class="a-normal text-light" title="Dinas Pendidikan, Pemuda dan Olahraga">Beranda</a></li>
                            <?php $menu1 = $navMenu1; ?>
                            <li>
                            ...
                            <li>
                                ...
                                <table border="0" style="margin-center: -11%;">
                                    <tr>
                                        <th colspan="1"><small>&nbsp;</small></th>
                                    </tr>
                                    <tr>
            ...
            <nav id="navperma" class="navbar">
                <div class="container">
                    ...
                    <div id="brandperma" class="d-flex justify-content-start align-items-center pt-1">
                        <ul class="navbarku">
                            <li><a href="<?php echo base_url(); ?>" title="Dinas Pendidikan, Pemuda dan Olahraga" class="text-light">Beranda</a></li>
                            <?php $menu1 = $navMenu1; ?>
                            <li>
                                <a href="javascript:void(0)<?php //echo base_url('halaman/'.$menu1['nav_slug']);?>" class="a-normal text-light">
                                    <?php echo $menu1['page'][$menu1['menu']['menu_ID']]['title'];?>
                ...
                <div class="container">
                    <div class="row justify-content-center mb-5 animate__animated animate__fadeInUp">
                        <div class="col-lg-2 d-inline-flex text-center justify-content-center">
                            <!--img id="logoku" src="<?php //echo base_url(); ?>/assets/dpuprkab1.png" width="100"-->
                        </div>
                        <!--h4 class="text-center fw-bolder d-none">D P U P R</h4-->
                    </div>
        ...
        <div class="py-5">
            ...
            <div class="d-flex justify-content-center pb-4">
                    <div class="d-inline-block pt-3 pb-4 px-2 bg-ornamen">Berita Terbaru</div>
                </div>
                            ...
                            <div class="carousel-item<?php if((3*$i)+0 == 0) echo ' active'; ?>">
                                <div class="row mx-1">
                                    <div class="carousel-col col-lg-4 ps-5">
                                        <a href="<?php echo base_url('artikel/'.$newsletter[(3*$i)+0]['slug']); ?>" class="d-block a-normal text-dark a-link" title="<?php echo $newsletter[(3*$i)+0]['title']; ?>">
                                            <div class="inner-group d-block bg-warning-op-85">
                                                <div class="featured-image" style="background-image: url('<?php echo $newsletter[(3*$i)+0]['featured_image'];?>'); background-size: cover; background-position: center top;"></div>
                                                <div class="featured-title d-block">
                                                    <p class="fw-bolder m-0 py-2 px-3">
                                    ...
                                    <div class="carousel-col col-lg-4 ps-3 pe-3">
                                        <a href="<?php echo base_url('artikel/'.$newsletter[(3*$i)+1]['slug']); ?>" class="d-block a-normal text-dark a-link" title="<?php echo $newsletter[(3*$i)+1]['title']; ?>">
                                            <div class="inner-group d-block bg-warning-op-85 cursor-pointer">
                                                <div class="featured-image" style="background-image: url('<?php echo $newsletter[(3*$i)+1]['featured_image'];?>'); background-size: cover; background-position: center top;"></div>
                                                <div class="featured-title d-block">
                                                    <p class="fw-bolder m-0 py-2 px-3">
                                    ...
                                    <div class="carousel-col col-lg-4 pe-5">
                                        <a href="<?php echo base_url('artikel/'.$newsletter[(3*$i)+2]['slug']); ?>" class="d-block a-normal text-dark a-link" title="<?php echo $newsletter[(3*$i)+2]['title']; ?>">
                                            <div class="inner-group d-block bg-warning-op-85 cursor-pointer">
                                                <div class="featured-image" style="background-image: url('<?php echo $newsletter[(3*$i)+2]['featured_image'];?>'); background-size: cover; background-position: center top;"></div>
                                                <div class="featured-title d-block">
                                                    <p class="fw-bolder m-0 py-2 px-3">
                ...
                <div class="d-flex justify-content-center">
                    <a href="<?php echo base_url('artikel/arsip/7'); ?>" class="d-inline-block mt-4 py-1 px-3 border border-1 rounded-pill a-normal">
            ...
            <div class="d-flex justify-content-center pb-4">
                    <div class="d-inline-block pt-1 pb-4 px-2 bg-ornamen">Pengumuman</div>
                </div>
                    ...
                    <div class="carousel-inner">
                        ...
                        <?php for($i=0; $i<$announceMax; $i++): ?>
                            <div class="carousel-item<?php if((3*$i)+0 == 0) echo ' active'; ?>">
                                <div class="row mx-1">
                                    <div class="carousel-col col-lg-4 ps-5">
                                        <a href="<?php echo base_url('artikel/'.$announcement[(3*$i)+0]['slug']); ?>" class="d-block a-normal text-dark a-link" title="<?php echo $announcement[(3*$i)+0]['title']; ?>">
                                            <div class="inner-group d-block bg-warning-op-85">
                                                <div class="featured-image" style="background-image: url('<?php echo $announcement[(3*$i)+0]['featured_image'];?>'); background-size: cover; background-position: center top;"></div>
                                                <div class="featured-title d-block">
                                                    <p class="fw-bolder m-0 py-2 px-3">
                                                        <?php echo substr($announcement[(3*$i)+0]['title'],0,55); ?> ...<br>
                                                        <small class="fw-normal">
                                                            <i class="bi bi-clock"></i>
                                    ...
                                    <div class="carousel-col col-lg-4 ps-3 pe-3">
                                        <a href="<?php echo base_url('artikel/'.$announcement[(3*$i)+1]['slug']); ?>" class="d-block a-normal text-dark a-link" title="<?php echo $announcement[(3*$i)+1]['title']; ?>">
                                            <div class="inner-group d-block bg-warning-op-85 cursor-pointer">
                                                <div class="featured-image" style="background-image: url('<?php echo $announcement[(3*$i)+1]['featured_image'];?>'); background-size: cover; background-position: center top;"></div>
                                                <div class="featured-title d-block">
                                                    <p class="fw-bolder m-0 py-2 px-3">
                                                        <?php echo substr($announcement[(3*$i)+1]['title'],0,55); ?> ...<br>
                                                        <small class="fw-normal">
                                                            <i class="bi bi-clock"></i>
                                    ...
                                    <div class="carousel-col col-lg-4 pe-5">
                                        <a href="<?php echo base_url('artikel/'.$announcement[(3*$i)+2]['slug']); ?>" class="d-block a-normal text-dark a-link" title="<?php echo $announcement[(3*$i)+2]['title']; ?>">
                                            <div class="inner-group d-block bg-warning-op-85 cursor-pointer">
                                                <div class="featured-image" style="background-image: url('<?php echo $announcement[(3*$i)+2]['featured_image'];?>'); background-size: cover; background-position: center top;"></div>
                                                <div class="featured-title d-block">
                                                    <p class="fw-bolder m-0 py-2 px-3">
                                                        <?php echo substr($announcement[(3*$i)+2]['title'],0,55); ?> ...<br>
                                                        <small class="fw-normal">
                                                            <i class="bi bi-clock"></i>
                ...
                <div class="d-flex justify-content-center">
                    <a href="<?php echo base_url('artikel/arsip/6'); ?>" class="d-inline-block mt-4 py-1 px-3 border border-1 rounded-pill a-normal">
        ...
        <!-- Floating chat -->
        <div id="chatku">
            <a href="#chatku" class="d-inline-flex justify-content-center align-items-center bg-info rounded-circle" data-bs-html="true" data-bs-toggle="popover" data-bs-content="<!-- <i class='bi bi-whatsapp'></i> <a href='https://wa.me' class='a-normal'>Whatsapp</a><br><i class='bi bi-telegram'></i> <a href='https://t.me' class='a-normal'>Telegram</a><br> --><span class='fs-6'><i class='bi bi-envelope'></i> <a href='mailto:dikpora@wonosobokab.go.id' class='a-normal'>Email</a></span>">
