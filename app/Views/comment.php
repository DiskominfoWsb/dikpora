                ...
                <?php foreach($comments as $c): ?>
                    ...
                    <tr id="msg-<?php echo $c->ID; ?>" <?php echo $bgColor; ?>>
                        ...
                        <td rowspan="2" class="text-center">
                            <a href="#comment-<?php echo $c->type.'-'.$c->ID.'-'.$c->ID_post_page; ?>" class="comment-reply" data-bs-toggle="modal" data-bs-target="#modalComment">
                        ...
                        <td rowspan="2" class="text-center" style="white-space: nowrap;">
                            <small><?php echo str_replace(' ', '<br>', $c->date_submit); ?></small>
                        </td>
                    </tr>
                    <tr<?php echo $bgColor; ?>>
